...
//
//
//public class MapsActivityNew_Backup extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
//        OnMapReadyCallback, RoutingListener, GoogleMap.OnMarkerClickListener, View.OnClickListener, FinishDialog.SendData, TempratureDialogFragment.SendData, GeoTask.Geo {
//
...
//
//        showLoading = new ShowLoading(MapsActivityNew_Backup.this);
...
//            public void onClick(View v) {
//                finish();
//                Intent intent = new Intent(MapsActivityNew_Backup.this, FarmListRoute.class);
...
//
//                    System.out.println("ewewewuiweuiewuew " + url);
//                    new GeoTask(MapsActivityNew_Backup.this, "set").execute(url, "set");
//
//
...
//
//            String url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins=" + origin + "&destinations=" + destinations + "&mode=driving&units=imperial&key=AIzaSyBKuDPXLD9BVKhISPpUd4fyyenbbJGgZRo";
//            new GeoTask(MapsActivityNew_Backup.this, "update").execute(url, "update");
//        }
//
//    }
//
...
//                        .withListener(MapsActivityNew_Backup.this)
...
//                public void run() {
//                    if (meter <= 100.0) {
//                        Toast.makeText(MapsActivityNew_Backup.this, "Arrived", Toast.LENGTH_SHORT).show();
//                        timedelay = 3000;
//                        // sendLog("Arrived");
//                    }
//                }
...
//
//                bottomSheetDialogFragment = new FinishDialog().instance(marker.getSnippet(), MapsActivityNew_Backup.this);
//                bottomSheetDialogFragment.show(getSupportFragmentManager(), bottomSheetDialogFragment.getTag());
//
//            } else {
...
//            final Dialog dialog = new Dialog(MapsActivityNew_Backup.this, cn.pedant.SweetAlert.R.style.MyDialog);
...
//                @Override
//                public void onClick(View view) {
//                    new LoadTemprature(MapsActivityNew_Backup.this, MapsActivityNew_Backup.this, "" + routePlannerDetail.getFIRMID(), sharedprefrenceManager.getRouteName()).createDialog();
//
...
//                            bottomSheetDialogFragment = new TempratureDialogFragment().instance(routePlannerDetail, marker.getSnippet(), MapsActivityNew_Backup.this);
//                            bottomSheetDialogFragment.show(getSupportFragmentManager(), bottomSheetDialogFragment.getTag());
////                                return true;
//                        } else {
...
//                                            Log.e("OnCancel", sharedprefrenceManager.getRideId());
//                                            System.err.println("OnCancel ::::" + "Ride Cancelled !");
//                                            Toast.makeText(MapsActivityNew_Backup.this, "Ride Canceled", Toast.LENGTH_LONG).show();
//                                            Intent intent = new Intent(MapsActivityNew_Backup.this, SelectCar.class);
//                                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                                            startActivity(intent);
//                                            finish();
//                                        } else {
...
//
//    @Override
//    public void finishData(String endodometerreading, String totalmiles) {
//        isCounterCanceled = true;
//        FinishData(endodometerreading, totalmiles);
//    }
//
...
//
//            showLoading.show();
//            Call<CommonError> call = apiService.finishRide(sharedprefrenceManager.getRideId(), sharedprefrenceManager.getDriverID(), "" + location.getLatitude(), "" + location.getLongitude(), endodometer, address, state, city, country, "End", totalmiles);
//            call.enqueue(new Callback<CommonError>() {
//                @Override
//                public void onResponse(Call<CommonError> call, Response<CommonError> response) {
//                    if (response.code() == 200) {
...
//                            status.startResolutionForResult(MapsActivityNew_Backup.this, 100);
//
...
//                            mMap.clear();
//                            setUpMap();
//                            displayLocationSettingsRequest(MapsActivityNew_Backup.this);
...
//                        try {
//                            // in onActivityResult().
//                            status.startResolutionForResult(MapsActivityNew_Backup.this, REQUEST_CHECK_SETTINGS);
//                        } catch (IntentSender.SendIntentException e) {
...
//        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=AIzaSyBKuDPXLD9BVKhISPpUd4fyyenbbJGgZRo";
//
//        return url;
//    }
//
