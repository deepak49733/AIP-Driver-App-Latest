...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Intent serviceIntent = new Intent(this, GeofenceRegistrationService.class);
       // startService(serviceIntent);

//        startService(new Intent(MainActivity.this, GeofenceRegistrationService.class));
...
//                    });
    ...
    private void startGeofencing() {
        ...
        geofencingRequest = new GeofencingRequest.Builder()
                .setInitialTrigger(Geofence.GEOFENCE_TRANSITION_ENTER| GeofencingRequest.INITIAL_TRIGGER_DWELL)
...
//                .setTransitionTypes(Geofence.GEOFENCE_TRANSITION_DWELL)
 //               .setLoiteringDelay(10000) //10 seconds for staying in geofence
    ...
    private PendingIntent getGeofencePendingIntent() {
        ...
        return PendingIntent.getService(this, 1, intent, PendingIntent.
                FLAG_UPDATE_CURRENT);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_stop_monitor){
            stopGeoFencing();
        }
        if (item.getItemId() == R.id.action_start_monitor){
            startGeofencing();
        }
